      ...
      {lanternTags.map((tag) => {
        ...
        return (
          <button
            ...
            className="inline-flex min-h-9 items-center gap-1.5 rounded-none border px-2.5 text-xs transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
            style={{
